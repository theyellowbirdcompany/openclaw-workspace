...
description: Production-tested Tailwind v4 + shadcn/ui setup. Prevents 8 documented errors through mandatory four-step CSS variable theming for automatic dark mode. Use when setting up Tailwind v4 with shadcn/ui, configuring CSS variables for theming, or debugging Tailwind + shadcn integration issues.
model: fast
---
